...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactTabs = __webpack_require__(172);
	...
	if (element) ReactDOM.render(React.createElement(StatsOverview, null), element);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElementValidator = {
	  ...
	  createElement: function createElement(type, props, children) {
	    ...
	    process.env.NODE_ENV !== 'production' ? warning(validType, 'React.createElement: type should not be null, undefined, boolean, or ' + 'number. It should be a string (for DOM elements) or a ReactClass ' + '(for composite react).%s', getDeclarationErrorAddendum()) : void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function runBatchedUpdates(transaction) {
	  ...
	  !(len === dirtyComponents.length) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Expected flush transaction\'s stored dirty-react length (%s) to ' + 'match dirty-react array length (%s).', len, dirtyComponents.length) : invariant(false) : void 0;
	  ...
	  unmountComponent: function unmountComponent(safely) {
	    switch (this._tag) {
	      ...
	      case 'body':
	         ...
	         */
	         true ? process.env.NODE_ENV !== 'production' ? invariant(false, '<%s> tried to unmount. Because of cross-browser quirks it is ' + 'impossible to unmount some top-level react (eg <html>, ' + '<head>, and <body>) reliably and efficiently. To fix this, have a ' + 'single top-level component that never unmounts render these ' + 'elements.', this._tag) : invariant(false) : void 0;
	        break;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function warnIfValueIsNull(props) {
	  if (props != null && props.value === null && !didWarnValueNull) {
	    process.env.NODE_ENV !== 'production' ? warning(false, '`value` prop on `input` should not be null. ' + 'Consider using the empty string to clear the component or `undefined` ' + 'for uncontrolled react.') : void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function warnIfValueIsNull(props) {
	  if (props != null && props.value === null && !didWarnValueNull) {
	    process.env.NODE_ENV !== 'production' ? warning(false, '`value` prop on `select` should not be null. ' + 'Consider using the empty string to clear the component or `undefined` ' + 'for uncontrolled react.') : void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function warnIfValueIsNull(props) {
	  if (props != null && props.value === null && !didWarnValueNull) {
	    process.env.NODE_ENV !== 'production' ? warning(false, '`value` prop on `textarea` should not be null. ' + 'Consider using the empty string to clear the component or `undefined` ' + 'for uncontrolled react.') : void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function instantiateReactComponent(node) {
	  ...
	  if (node === null || node === false) {
	    ...
	    var element = node;
	    !(element && (typeof element.type === 'function' || typeof element.type === 'string')) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Element type is invalid: expected a string (for built-in react) ' + 'or a class/function (for composite react) but got: %s.%s', element.type == null ? element.type : _typeof(element.type), getDeclarationErrorAddendum(element._owner)) : invariant(false) : void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCompositeComponentMixin = {
	  ...
	  attachRef: function attachRef(ref, component) {
	    ...
	    !(inst != null) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Stateless function react cannot have refs.') : invariant(false) : void 0;
	    var publicComponentInstance = component.getPublicInstance();
	    if (process.env.NODE_ENV !== 'production') {
	      var componentName = component && component.getName ? component.getName() : 'a component';
	      process.env.NODE_ENV !== 'production' ? warning(publicComponentInstance != null, 'Stateless function react cannot be given refs ' + '(See ref "%s" in %s created by %s). ' + 'Attempts to access this ref will fail.', ref, componentName, this.getName()) : void 0;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsStylesheet = __webpack_require__(176);

	var _jsStylesheet2 = _interopRequireDefault(_jsStylesheet);

	var _helpersUuid = __webpack_require__(177);

	var _helpersUuid2 = _interopRequireDefault(_helpersUuid);

	var _helpersChildrenPropType = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AccountNav = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'account-nav-trigger', onClick: this.showContent },
	                React.createElement('img', { className: 'account-avatar', src: 'https://www.gravatar.com/avatar/d5d3310834b43c6f96e200339734c949?s=20&d=https%3A%2F%2Fparagon.gg%2Fimages%2Fdefault-avatar.png', alt: 'Your avatar' }),
	                React.createElement(
	                    'span',
	                    null,
	                    'Jamie'
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'ul',
	                    { className: 'account-properties' },
	                    React.createElement(
	                        'li',
	                        null,
	                        React.createElement(
	                            'a',
	                            { href: '/users/jamieshepherd' },
	                ...
	                React.createElement(
	                    'a',
	                    { href: '/logout', className: 'sign-out' },
	...
	if (element) ReactDOM.render(React.createElement(AccountNav, null), element);
